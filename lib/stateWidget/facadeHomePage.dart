import 'package:facade/facadeFunction/smartHomeFacade.dart';
import 'package:facade/icons/device_icon.dart';
import 'package:facade/icons/mode_switcher.dart';
...
class _FacadeHomePageState extends State<FacadeHomePage> {
  ...
  void _changeHomeCinemaMode(bool activated) {
    if (activated) {
      _smartHomeFacade.startMovie(_smartHomeState,'moive');
    } else {
